...
COMPILE_VERSION_LIBDE265=$(cat build.sh | egrep -o 'COMPILE_VERSION_LIBDE265=([0-9.-]+)' | cut -f 2 -d =)
COMPILE_VERSION_LIBWEBP=$(cat build.sh | egrep -o 'COMPILE_VERSION_LIBWEBP=([0-9.-]+)' | cut -f 2 -d =)
COMPILE_VERSION_LIBHEIF=$(cat build.sh | egrep -o 'COMPILE_VERSION_LIBHEIF=([0-9.-]+)' | cut -f 2 -d =)
COMPILE_VERSION_IMAGEMAGICK=$(cat build.sh | egrep -o 'COMPILE_VERSION_IMAGEMAGICK=([0-9.-]+)' | cut -f 2 -d =)
